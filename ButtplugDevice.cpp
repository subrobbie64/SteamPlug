...
AbstractButtDevice::AbstractButtDevice(ButtplugConfig& config) : _config(config), _effectiveVibrationPercent(0) {
...
void AbstractButtDevice::adjustVibration(int bySmallRumble, int byBigRumble) {
...
void AbstractButtDevice::setVibrate(unsigned char smallRumble, unsigned char bigRumble) {
...
int AbstractButtDevice::getEffectiveVibration() const {
...
void ButtplugDevice::setVibrate(unsigned char effectiveVibrationPercent) {
...
const std::string& ButtplugDevice::getDeviceId() const {
	return _deviceId;
}
...
const int ButtplugDevice::CONNECT_RETRY_MS = 2500;
...
const ButtplugDeviceDefinition ButtplugDevice::HUSH_DEVICE[] = {
...
const int ButtplugDevice::NUM_HUSH_DEVICES = sizeof(HUSH_DEVICE) / sizeof(HUSH_DEVICE[0]);
